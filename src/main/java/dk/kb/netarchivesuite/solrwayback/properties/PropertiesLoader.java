...
public class PropertiesLoader {
	...
	private static final String PROXY_ALLOW_HOST_PROPERTY="proxy.allow.host";
	...
	public static String PROXY_ALLOW_HOST= null;
	...
	public static void initProperties()  throws Exception{
		...
		PROXY_ALLOW_HOST = serviceProperties.getProperty(PROXY_ALLOW_HOST_PROPERTY);
		...
		log.info("Property:"+ PROXY_ALLOW_HOST_PROPERTY +" = " + PROXY_ALLOW_HOST);		
