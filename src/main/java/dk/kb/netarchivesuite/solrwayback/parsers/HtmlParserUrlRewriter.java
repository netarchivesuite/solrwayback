...
public class HtmlParserUrlRewriter {
    ...
    //example: <meta http-equiv="refresh" content="0;URL=http://solrwayback.dk/index.shtml">
    //URL can also be lowercase
    private static String META_REFRESH_URL_PATTERN_STRING ="(?i)(<meta\\b[^>]*http-equiv\\s*=\\s*[\"']refresh[\"'][^>]*content\\s*=\\s*[\"'][^\"'>]*;\\s*url=)([^\"'>\\s]+)";
