...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = doForEachMonthInDatesObject;
/* harmony export (immutable) */ __webpack_exports__["a"] = doForEachWeekAndDayInDatesObject;
/**
 ...
 * @param {Function} actionFunction The callback to execute for every month.
 */
function doForEachWeekAndDayInDatesObject(datesObject, actionFunction) {
...
function addActivityLevelToMonths(datesObject, transformationFunction) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__iterators__["b" /* doForEachMonthInDatesObject */])(datesObject, (year, month) => {
 ...
 * @param {Function} transformationFunction The function to calculate activity level from transformation-functions.js
 */
function addActivityLevelToWeeks(datesObject, transformationFunction) {
    ...
    // Loop through each month and assign the activityLevel
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__iterators__["a" /* doForEachWeekAndDayInDatesObject */])(datesObject, (year, week, day) => {
...
function buildWeekObject(year, parsedHarvestDates) {
    ...
    const daysInYear = __WEBPACK_IMPORTED_MODULE_2_date_fns_get_days_in_year___default()(day);
    const theLastDayOfYear = __WEBPACK_IMPORTED_MODULE_4_date_fns_last_day_of_year___default()(day);
    ...
    while (__WEBPACK_IMPORTED_MODULE_3_date_fns_is_before___default()(day, theLastDayOfYear)) {
        ...
        const harvestsForDay = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* sortDatesDescending */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__date__["a" /* getHarvestsForDay */])(day, parsedHarvestDates));
